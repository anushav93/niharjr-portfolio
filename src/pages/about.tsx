...
const About: React.FC = () => {
    return (<Layout>
        <>
        <div className="mt-12 mb-6 px-4 md:px-8 flex flex-row items-end gap-x-3 ">
            <h1 className="font-medium text-6xl text-blue-600">CREATING </h1> <h1 className="text-4xl italic font-extralight text-blue-600">VISUAL PEACE</h1>
        </div>
        ...
        <div className="px-4 md:px-8 flex flex-col pt-12 ">
           ...
           <div className="grid grid-cols-12 pt-24">
                ...
                <div className="col-span-12 md:col-span-6">
                  ...
                  A professional photographer capturing the light and emotions in my way. 
                  
                  <br/><br/>Skilled in capturing nature, action, 
                candid moments, can create beautiful, authentic, and meaningful photographs that capture the essence of weddings and events.
                  </h4>
                </div>
           </div>
        </div>
